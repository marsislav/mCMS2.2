       <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
           ...
           <div class="navbar-header">
               ...
               <a class="navbar-brand" href="index.php">mCMS 2.2 - Admin</a>
           </div>
           <!-- Top Menu Items -->
...
?>
           ...
           <div class="collapse navbar-collapse navbar-ex1-collapse">
               <ul class="nav navbar-nav side-nav">
                   ...
                   <li>
                       <a href="javascript:;" data-toggle="collapse" data-target="#pages_dropdown"><i
                               class="fa fa-fw fa-arrows-v"></i>Pages <i class="fa fa-fw fa-caret-down"></i></a>
